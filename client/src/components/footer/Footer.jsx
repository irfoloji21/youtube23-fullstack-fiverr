    ...
    <footer className="footer pt-5 pb-3 px-3 px-sm-4 px-md-5 border-top border-1 border-opacity-10 text-muted">
        <div className="footer-links d-flex flex-wrap justify-content-lg-between" style={{columnGap: '15px'}}>
          <div className="mb-4 links-categories" style={{minWidth: '160px'}}>
            <p className="text-black fw-semibold fs-6">{Text.Footer.headers.header1}</p>
            <ul>
              <li><a href="#">{Text.Footer.listItem.listItem1}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem2}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem3}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem4}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem5}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem6}</a></li>
            </ul>
          </div>
          <div className="mb-4 links-about" style={{minWidth: '160px'}}>
            <p className="text-black fw-semibold fs-6">{Text.Footer.headers.header2}</p>
            <ul>
              <li><a href="#">{Text.Footer.listItem.listItem7}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem8}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem9}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem10}</a></li>
            </ul>
          </div>
          <div className="mb-4 links-support" style={{minWidth: '160px'}}>
            <p className="text-black fw-semibold fs-6">{Text.Footer.headers.header3}</p>
            <ul>
              <li><a href="#">{Text.Footer.listItem.listItem11}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem12}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem13}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem14}</a></li>
            </ul>
          </div>
          <div className="mb-4 links-community" style={{minWidth: '160px'}}>
            <p className="text-black fw-semibold fs-6">{Text.Footer.headers.header4}</p>
            <ul>
              <li><a href="#">{Text.Footer.listItem.listItem15}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem16}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem17}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem18}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem19}</a></li>
            </ul>
          </div>
          <div className="mb-4 links-more" style={{minWidth: '160px'}}>
            <p className="text-black fw-semibold fs-6">{Text.Footer.headers.header5}</p>
            <ul>
              <li><a href="#">{Text.Footer.listItem.listItem20}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem21}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem22}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem23}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem24}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem25}</a></li>
              <li><a href="#">{Text.Footer.listItem.listItem26}</a></li>
            </ul>
          </div>
        </div>
        <div className="footer-rights-wrapper py-3 my-auto border-top border-1 border-opacity-10 d-flex flex-column flex-sm-row justify-content-center justify-content-sm-between align-items-center">
          <div className="footer-rights d-flex flex-column flex-md-row justify-content-center align-items-center" style={{gap: '18px'}}>
            <img src="./svg/logo.svg" alt="fiverr" />
            <div className="text-center align-middle my-auto">© Fiverr International Ltd. 2022</div>
          </div>
          <div className="footer-social d-flex flex-column flex-md-row justify-content-center align-items-center" style={{columnGap: '15px'}}>
            <ul className="d-flex align-items-center my-auto" style={{gap: '10px'}}>
